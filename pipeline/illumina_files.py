...
#            print "output_file from open_dataset_files = %s" % output_file
...
#        a = "/Users/ashipunova/BPC/py_mbl_sequencing_pipeline/test/data/fastq/illumina_files_test/Project_Julie_v6_30/Sample_v6_Amplicon_IDX1"
        ...
        self.read2(in_files_r1, compressed)
#        (dirpath1, dirname1, files1) = self.get_fastq_file_names(f_input_file_path)
...
#                for file in files:
#                    print "\n=============\nfile = %s" % file
#                    f_input  = fq.FastQSource(os.path.join(dirpath, file), compressed)
#
        ...
        for dirname, dirnames, filenames in os.walk(f_input_file_path):
            for filename in filenames:
                if filename.find('_R1_') > 0:
                    ...
                    sys.stderr.write("No read number in the file name: %s" % filename)
